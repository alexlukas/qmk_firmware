...
LAYOUT(
        //,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
        LT(_NAV, KC_GRV), KC_1, KC_2, KC_3, KC_4, KC_5, MO(_SYMB), MO(_SYMB), KC_6, KC_7, KC_8, KC_9, KC_0, LT(_NAV,
                                                                                                               KC_MINS),
//,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, LBRCK_CTRL, RBRCK_CTRL, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_EQL,
//,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
        KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, LT(_ADJUST, KC_PGUP), LT(_ADJUST,
...
//,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
        KC_LGUI, MO(
        _UMLAUTS), KC_BSLASH, ALT_AST, CTRL_SL, KC_BSPC, KC_DEL, KC_ENT, KC_SPC, KC_RALT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
//,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
),
