...
[_QWERTY] = LAYOUT(
        ...
        //,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
        KC_LSFT,           KC_Z,   KC_X,       KC_C,       KC_V,   KC_B,   KC_PGDN,                   KC_HOME,             KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLASH,   KC_RSPC,
        //,-----------------+--------+----------+-----------+---------+------+---------------------.   ,-------------------+-------+--------+-------+-------+---------+---------------------.
...
[_SYMB] = LAYOUT(
        ...
        _______, KC_HASH, KC_DLR , KC_LBRC, KC_RBRC, KC_GRV,  KC_INS ,                             KC_INS , XXXXXXX, KC_KP_4, KC_KP_5, KC_KP_6, KC_APP   , KC_PSCR,
        _______, KC_PERC, KC_CIRC, KC_LPRN, KC_RPRN, KC_TILD, _______,                             _______, XXXXXXX, KC_KP_1, KC_KP_2, KC_KP_3, XXXXXXX  , KC_LSCR,
